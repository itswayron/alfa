...
class UserNotValidException(name: String? = null, errors: List<String> = emptyList()) :
  IllegalArgumentException(ExceptionErrorMessages.USER_NOT_VALID.message), ApiException {
